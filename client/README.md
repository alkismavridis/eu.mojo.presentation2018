...
To try it, delete all the code in `src/App.js` and replace it with any of the examples on its website. The [Basic Greeter](https://reacttraining.com/react-router/web/example/basic) is a good place to get started.
...
```sh
    ...
    ? What Firebase project do you want to associate as default? Greeter app (example-app-fd690)
